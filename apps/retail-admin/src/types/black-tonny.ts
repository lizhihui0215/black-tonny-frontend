...
export type BlackTonnyPageShellKind = 'dashboard' | 'standard';
...
export interface BlackTonnyInventorySalesRelationship extends Record<
  string,
  unknown
> {
  data_basis?: string[];
...
export interface BlackTonnyPageSpec {
  ...
  shellKind: BlackTonnyPageShellKind;
...
export type DashboardSummaryPreset =
  | 'today'
  | 'yesterday'
  | 'last7days'
  | 'last30days'
...
export type DashboardSummaryCompareDirection = 'down' | 'flat' | 'up';

export type DashboardSummaryCompareType = 'rate' | 'value';
...
export interface DashboardSummaryDateRange {
...
export interface DashboardSummaryMetric {
  compareDirection: DashboardSummaryCompareDirection;
  compareType: DashboardSummaryCompareType;
...
export type DashboardSummaryMetrics = Record<
